...
export function SharedJsonInput({
  ...
  return (
    <div className="h-full flex flex-col">
      {/* File name indicator */}
      {fileName && (
        <div className="mb-3 px-3 py-1.5 bg-muted/50 rounded-md border">
    ...
    <TooltipProvider>
      <div className="flex items-center gap-1">
        {onFormat && (
          <Tooltip>
            <TooltipTrigger asChild>
              <Button variant="ghost" size="icon" onClick={onFormat} disabled={disabled} className="h-7 w-7">
        ...
        {onCopy && (
          <Tooltip>
            <TooltipTrigger asChild>
              <Button variant="ghost" size="icon" onClick={onCopy} disabled={disabled} className="h-7 w-7">
        ...
        {onDownload && (
          <Tooltip>
            <TooltipTrigger asChild>
              <Button variant="ghost" size="icon" onClick={onDownload} disabled={disabled} className="h-7 w-7">
        ...
        {onUpload && (
          <Tooltip>
            <TooltipTrigger asChild>
              <Button variant="ghost" size="icon" onClick={onUpload} className="h-7 w-7">
